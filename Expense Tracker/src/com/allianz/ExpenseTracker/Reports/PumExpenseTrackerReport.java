...
public class PumExpenseTrackerReport extends JPopupMenu {
	...
	public PumExpenseTrackerReport() {
		
	}
	public PumExpenseTrackerReport(ObjectsExpenseReport objReport) {
        ...
        item1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				PnlItemDetailsAnzeigen details = new PnlItemDetailsAnzeigen(objReport,"Y");
        ...
        item2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				PnlItemDetailsAnzeigen details = new PnlItemDetailsAnzeigen(objReport,"D");
				details.getFrmItemDetails().setVisible(true);
			}
		});
