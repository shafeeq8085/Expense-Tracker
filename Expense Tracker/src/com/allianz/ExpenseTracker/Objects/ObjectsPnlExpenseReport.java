...
public class ObjectsPnlExpenseReport {
	...
	public ObjectsPnlExpenseReport() {
...
//		date = dtf.format(localDate.minusDays(30));
	...
	public ObjectsPnlExpenseReport(String frmDate, String toDate) {
		
		setFrmDate(frmDate);
		setToDate(toDate);
	}
	
	public ObjectsPnlExpenseReport(String frmDate, String toDate, String flagShow, String categShow) {
